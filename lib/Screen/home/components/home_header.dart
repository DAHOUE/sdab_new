            ...
            Row(
              children: [
                Padding(padding: EdgeInsets.only(top: 20,left: 20),
                  child: Text(actuality,style: TextStyle(fontSize: 60,fontWeight: FontWeight.bold,color: Colors.white),),)
              ],
            ),
            Row(
              children: [
            ...
            Row(
              children: [
                Padding(padding: EdgeInsets.only(top: 20,left: 20,bottom: 50),
                  child: Text(another_actuality,style: TextStyle(fontSize: 18,color: Colors.white),),
                )
              ],
            ),
