...
class _Body extends State<Body> {
  ...
  TextEditingController statutController = new TextEditingController();
  TextEditingController mdpController = new TextEditingController();
  TextEditingController mdpSecondController = new TextEditingController();
        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              ...
              child:  DropdownButtonFormField(
                ...
                items: [
                  ...
                  DropdownMenuItem(child: Text("Fournisseur de service"), value: 4,),
                ],
                onChanged: (value){
                  setState(() {
                    _valu = value;
                  ...
                  print(_valu);
                  if(_valu==1)
                    constants.type ='Producteur';
                  else if(_valu==2)
                    constants.type = 'Transformateur';
                  else if(_valu==3)
                    constants.type ='Commerçant';
                  else if(_valu==4)
                    constants.type ="Fournisseur de service";
                },
                decoration: InputDecoration(
                    labelText: "Statut",
                    labelStyle: TextStyle(color: Colors.black54)
            ...
            Padding(
              ...
              child: ListTile(
                subtitle: TextFormField(
                  controller: mdpSecondController,
                  obscureText: true,
                  decoration: InputDecoration(
                  ...
                  validator: (value){
                    if(value.isEmpty)
                      ...
                      if(mdpController.text.toString()!=value)
                        return 'Saisir le même mots de passe';
                    else
                      return null;
                  },
